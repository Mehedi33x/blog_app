                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <form action="{{ route('createpost.store') }}" method="POST" id="contact-form"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-message" name="blog" id="blog" rows="7" required></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button class="btn btn-primary solid blank mt-3" type="submit">POST</button>
                                    </div>
                                </div>
                            </form>
                        </div>
